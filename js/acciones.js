...
{ 
    ...
    $.ajax({  
		type: "POST",
		url: "http://192.168.0.101/libreria/buscarTodos.php",
		data: datos, 
		error: function() {  
...
{ 
    ...
    $.ajax({  
		type: "POST",
		url: "http://192.168.0.101/libreria/buscarTitulo.php",
		data: datos, 
		error: function() {  
			alert("Error, no se puede conectar al servidor");
		}, 
...
{ 
    ...
    $.ajax({  
		type: "POST",
		url: "http://192.168.0.101/libreria/buscarAutor.php",
		data: datos, 
		error: function() {  
			alert("Error, no se puede conectar al servidor");
		}, 
...
{ 
    ...
    $.ajax({  
		type: "POST",
		url: "http://192.168.0.101/libreria/buscarEditorial.php",
		data: datos, 
		error: function() {  
			alert("Error, no se puede conectar al servidor");
		}, 
